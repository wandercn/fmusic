...
12. [ ] 向下兼容开发支持mac10.15系统，目前在m1mac笔记本上12.0系统上选择编译目标target 10.15能编译运行，但是在intel10.15真机上运行不了。
兼容mac10.15单独 开个仓库 https://github.com/wandercn/myPlayer。有mac10.15系统的朋友可以帮忙试试能不能编译成功。

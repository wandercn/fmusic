...
9. [x] 左边栏支持隐藏
10. [x] 音乐音量调整
11. [x] **新增：播放列表管理**。支持创建、重命名、删除播放列表，支持从曲库右键添加歌曲到指定列表。
12. [x] **架构优化：曲库与播放队列分离**。切换视图内容不再干扰当前的播放顺序。
...
20. [x] **UI 改进：全新的侧边栏布局**。采用标准 NavigationView 结构，修复了表头遮挡和播放图标实时同步问题。(v1.1.1)
21. [x] 最新版本已经提供签名公证过的dmg文件（v1.1.0 2025.10.20)

...
struct ContentView: View {
    ...
    @State var currnetSong: Song = Song(name: "", artist: "", album: "", duration: TimeInterval(0), filePath: "", isSelected: false, isPlaying: false)
...
extension View {
    func itemBackgroundOnHover() -> some View {
        self.modifier(ItemBackgroundOnHover())
    }
}
